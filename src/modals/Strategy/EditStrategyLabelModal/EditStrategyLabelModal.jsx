...
const EditStrategyLabelModal = ({
  ...
  return (
    <Modal
      ...
      label={t('strategyEditor.editStrategyLabelModalTitle')}
    >
...
EditStrategyLabelModal.propTypes = {
...
EditStrategyLabelModal.defaultProps = {
  strategy: {
    label: '',
  },
  isOpen: true,
...
export default memo(EditStrategyLabelModal)
