...
export const GET_TRADES_EVENT = 'get-trades'
export const GET_INDICATORS_EVENT = 'get-indicators'
export const GET_INTERVAL_EVENT = 'get-interval'
export const GET_RANGE_EVENT = 'get-range'
