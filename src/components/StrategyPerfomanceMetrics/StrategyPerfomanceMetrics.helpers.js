...
const getMetrics = (results, t, quoteCcy, postProcessing = false) => {
  ...
  if (postProcessing) {
    return {
      ...
      [t('strategyEditor.retPerc')]: resultNumber(adjustPercentage(retPerc), null, null, true),
      [t('strategyEditor.drawdown')]: resultNumber(adjustPercentage(drawdown), null, false, true),
