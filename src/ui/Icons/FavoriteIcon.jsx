...
const FavoriteIcon = ({
  isSelected, onClick, value, nonFilled, selectedColor, nonSelectedColor, strokeColor,
}) => (
  <svg onClick={(event) => onClick(value, nonFilled, event)} role='button' aria-label='Favourite' tabIndex={0} width='12px' height='12px' viewBox='0 0 10 10' fill='none' xmlns='http://www.w3.org/2000/svg'>
    {nonFilled ? (
      <path d='M4.99998 8.02696L2.11567 9.54342L2.66665 6.33152L0.333313 4.05707L3.55783 3.58881L4.99998 0.666656L6.44213 3.58881L9.66665 4.05707L7.33331 6.33152L7.88428 9.54342L4.99998 8.02696Z' stroke={strokeColor} strokeWidth='0.5' strokeLinecap='round' strokeLinejoin='round' />
    ) : (
